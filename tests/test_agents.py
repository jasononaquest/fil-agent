...
class TestPrompts:
    ...
    def test_content_prompt_has_voice(self):
        ...
        assert "sarcastic" in CONTENT_INSTRUCTION.lower() or "sarcasm" in CONTENT_INSTRUCTION.lower()
    ...
    def test_research_prompt_has_validation(self):
        ...
        assert "verify" in RESEARCH_INSTRUCTION.lower() or "validate" in RESEARCH_INSTRUCTION.lower()
